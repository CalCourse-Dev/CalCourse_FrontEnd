    ...
    render() {
        return (
            <div style={{ color: 'white' }}>
                <h1>
                    By using and/or continuing to use our services, you agree to
                    the following policies, terms, and conditions.
                </h1>
                <h3 style={{ color: 'white' }}>Cookies Policy</h3>
                <p>
                    ...
                    Cookies and how that information is used. This Cookies
                ...
                <p>
                    ...
                    in and obtained from Cookies. For further information on how
                ...
                <ul>
                    <li>
                        ...
                        &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                        or &quot;Our&quot; in this Cookies Policy) refers to Cal
                        Course Development Team, Berkeley, CA 94720.
                    </li>
                    <li>
                    ...
                    <li>
                        <strong>Website</strong> refers to Cal Course,
                        accessible from{' '}
                        <a
                    ...
                    <li>
                        ...
                        using the Website, or a company, or any legal entity on
                        behalf of which such individual is accessing or using
                        the Website, as applicable.
                    </li>
                </ul>
                <h3 style={{ color: 'white' }}>The use of the Cookies</h3>
                <h3 style={{ color: 'white' }}>Type of Cookies We Use</h3>
                <p>
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            refers to Cal Course Development Team, Berkeley, CA
                            94720.
                        </p>
                    </li>
                    <li>
