...
import codingLoungeQRCode from "./CodingLounge.png";
      ...
      {!confirm ? (
        ...
        <div className="w-auto h-[40rem] bg-white border-[#e8e8e8] border-[1px] rounded-lg shadow-md flex lg:flex-col lg:h-auto md:flex-col md:h-auto">
          ...
          >
            ...
            <span className="text-[#767676] text-lg mt-36 tall:mt-0">
              Hans Mao
            </span>
            <h1 className="text-3xl text-[#1d1d1d]">30 Minute Meeting</h1>
              ...
              <form className="mr-3">
                ...
                <div className="mb-6">
                  <label
                    ...
                    className="block mb-2 text-sm font-medium text-gray-900"
                  >
                    描述下想在这期Coding Lounge里解决什么问题？（至少
                    80字，我们会根据回答分配合适的mentor。举个例子，如果是career
                    planning，请描述更具体一点，比方说是关于graduate
                    school的问题还是研究方向，etc) *
                  </label>
                  <textarea
                    id="description"
                    minLength={20}
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 h-[13vh]"
                    required
                  />
                </div>
                <div className="mb-3 gap-7">
                  ...
                  >
                    有加Coding Lounge Q&A 微信群吗? *
                  </label>
                  <br />
                  <div className="mb-3">
                    <img src={codingLoungeQRCode} height={180} width={180} />
                  </div>
                ...
                <div className="w-full flex justify-center">
                  <button
                    type="submit"
                    className="w-[10rem] text-white bg-[#0069ff] hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2"
                  >
